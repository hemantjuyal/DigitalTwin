...
namespace Microsoft.Unity
{
    ...
    static public class AsyncUtils
    {
        ...
        /// </param>
        static public async Task RunSafeVoid(this Behaviour behaviour, Func<Task> task, BehaviourErrorHandler onError)
        ...
        /// </param>
        static public async void RunSafeVoid(this Behaviour behaviour, Func<Task> task, bool disableOnError = true)
        {
            await RunSafeVoid(behaviour, task, (b, ex) => LogError(b, ex, disableOnError));
        }
