...
public class SiteOverviewUIPanel : MonoBehaviour
{
    ...
    private void PopulateUIMenu()
    {
        ...
        {
            Debug.Log("RoboticPalletizerID "+roboticPalletizerData.roboticPalletizerData.RoboticPalletizerID+"    "+"RoboticArmPowerComsumption "+roboticPalletizerData.roboticPalletizerData.RoboticArmPowerComsumption);
