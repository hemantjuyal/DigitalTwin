...
namespace BladeMR.ADT
{
    ...
    public class ADTRestClient
    {
        ...
        /// </summary>
        public RoboticPalletizerGameEvent OnADTReceivedTwinData;

        /// <summary>
        /// Event invoked when a digital twin property is updated on ADT.
        /// </summary>
        public RoboticPalletizerGameEvent OnUpdatedADTTwinProperty;
        ...
        /// <summary>
        /// Retrieves a Robotic Palletizer's properties from the ADT service.
        /// </summary>
        /// <param name="twinId">The ID of the Robotic Palletizer whose data is to be retrieved.</param>
        /// <returns>The properties of the Robotic Palletizer as stored in ADT.</returns>
        public async Task<RoboticPalletizerMetaData> GetRoboticPalletizerTwinData(string twinId)
        {
            await Authenticate();
            ...
            var roboticPalletizerData = JsonConvert.DeserializeObject<RoboticPalletizerMetaData>(twinContent);
            RoboticPalletizerScriptableObject roboticPalletizer = new RoboticPalletizerScriptableObject();
            roboticPalletizer.roboticPalletizerMetaData = roboticPalletizerData;
            OnADTReceivedTwinData.Raise(roboticPalletizer);

            Debug.Log($"Twin Data: [{twinContent}]");
            return roboticPalletizerData;
        }
