...
public class MapPinIndicator : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusHandler
{
    ...
    [SerializeField] 
    private RoboticPalletizerGameEvent onRoboticPalletizerSelected;
    ...
    public void Setup(RoboticPalletizerScriptableObject data)
    {
        ...
        Debug.Log("UI Related");
    }

    private void OnRoboticPalletizerDataUpdated()
    {
        HasAlert = roboticPalletizerData.roboticPalletizerMetaData.Alert;
    ...
    {
        onRoboticPalletizerSelected.Raise(roboticPalletizerData);
    }
