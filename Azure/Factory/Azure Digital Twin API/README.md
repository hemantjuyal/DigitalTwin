...
3. Import Azure Digital Twin Data Update API.postman_collection.json file using the following path -
...
6. Enter the Access Token under the Authorisation tab.

<img width="1440" alt="Screenshot 2023-11-14 at 23 59 05" src="https://github.com/hemantjuyal/DigitalTwin/assets/115024109/87b85292-f746-4ab2-87d1-67fe0df1ff6d">
...
8. Choose any of the Collection Item to update properties of any component, Update component ID and their values and click on "Send".
