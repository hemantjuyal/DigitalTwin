...
public class Telemetry
{
	...
	private static TelemetryData CreateTelemetryData(string line)
    {
		...
		double.TryParse(split[14], out data.PalletStretchMachineWrappingFilmUsage);
		return data;
	}
}
